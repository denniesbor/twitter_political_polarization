...
def query_db(category_table_column, date_value):
    ...
    if category_table_column == "All":
        result = (
            ...
            .filter(Twitter.created_at > date_value)
            .all()
        )
    ...
    if category_table_column == "Geo Political Policies":
        result = (
            ...
            .filter(
                and_(
                    Twitter.created_at > date_value,
                    Twitter.geopolitical_policy == "Geo Political Policies",
                )
            )
            .all()
        )
    ...
    if category_table_column == "Social Policies":
        result = (
            ...
            .filter(
                and_(
                    Twitter.created_at > date_value,
                    Twitter.social_policy == "Social Policies",
                )
            )
            .all()
        )
...
def political_category(party, df):
    ...
    df["party"] = df["party"].replace(
        ["R", "D", None], ["Republicans", "Democrats", "Other"], regex=True
    )
