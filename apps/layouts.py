...
date_picker = html.Div([
    ...
    dbc.Label("For the best user experience, data within a six-month window from the selection date is displayed"
              , color='secondary')
    ])
...
hist_bar_scatter = html.Div([
        dbc.Row([dbc.Col(html.P("Sentiment Distribution", className="bg-dark text-white p-2 mb-3"), lg=7),
                 dbc.Col(
                     dcc.Dropdown(
                        options = items,
                        value='Bar',
